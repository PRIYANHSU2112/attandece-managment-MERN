...
import { Search, Calendar, FileSpreadsheet, Menu } from 'lucide-react';
...
const Header = ({ activeTab, searchQuery, setSearchQuery, selectedDate, setSelectedDate, setProfileModalOpen, onMenuClick }) => {
  ...
  return (
    <header className="h-20 min-h-[80px] bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-slate-200 dark:border-slate-800 px-4 lg:px-8 flex items-center justify-between sticky top-0 z-10 transition-colors duration-300">
      <div className="flex items-center gap-4">
        ...
        <div className="hidden sm:flex items-center gap-4 bg-slate-50 dark:bg-slate-800 px-4 py-2.5 rounded-2xl md:w-96 border border-slate-100 dark:border-slate-700 transition-all focus-within:ring-2 ring-emerald-100">
      ...
      <div className="flex items-center gap-2 lg:gap-6">
        ...
        <div className="flex items-center rounded-xl border dark:border-slate-700 bg-slate-50 dark:bg-slate-800 px-2 lg:px-3 py-1.5 lg:py-2 text-slate-600 dark:text-slate-400">
          ...
          <input 
            ...
            className="bg-transparent text-[10px] lg:text-xs font-bold outline-none dark:color-white w-24 lg:w-auto"
          />
        </div>
        ...
        >
          ...
          <div className="w-9 h-9 lg:w-10 lg:h-10 bg-emerald-100 dark:bg-emerald-500/20 rounded-xl flex items-center justify-center text-emerald-700 dark:text-emerald-400 font-black shadow-inner uppercase text-sm lg:text-base">
